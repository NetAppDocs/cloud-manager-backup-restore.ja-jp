...
* Kubernetes の永続ボリュームのバックアップとリストアlink:concept-kubernetes-backup-to-cloud.html["詳細な機能については、こちらをご覧ください"]。
* アプリケーションデータをバックアップしていますlink:.html["詳細な機能については、こちらをご覧ください"]。
